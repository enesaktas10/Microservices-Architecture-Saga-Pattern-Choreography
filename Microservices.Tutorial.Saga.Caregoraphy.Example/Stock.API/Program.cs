...
MongoDBServices mongoDBServices = scope.ServiceProvider.GetService<MongoDBServices>();

var stockCollection =  mongoDBServices.GetCollection<Stock.API.Models.Stock>();
